...
Then, add `implementation group: 'org.cryptimeleon', name: 'craco', version: '2.0.0'` to the `dependencies` section of your `build.gradle` file.
...
dependencies {
    implementation group: 'org.cryptimeleon', name: 'craco', version: '2.0.0'
}
```
