...
public class PS18SignatureSchemeExprTest {

    private PS18SignatureSchemeExpr psScheme;
    ...
    @Before
    public void setUp() {
        SignatureSchemeParams params = PS18SignatureSchemeExprTestParamGen
                .generateParams(160, 2);
        this.psScheme = (PS18SignatureSchemeExpr) params.getSignatureScheme();
