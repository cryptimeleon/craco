...
public class PS18SignatureSchemeVectorTest {
    private PS18SignatureSchemeVector psScheme;
    ...
    @Before
    public void setUp() {
        SignatureSchemeParams params = PS18SignatureSchemeVectorTestParamGen
                .generateParams(160, 2);
        this.psScheme = (PS18SignatureSchemeVector) params.getSignatureScheme();
