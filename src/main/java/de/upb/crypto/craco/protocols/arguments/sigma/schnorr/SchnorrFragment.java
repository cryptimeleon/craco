 ...
 *     <ol>
 *         <li>The constructor is called with some data that contains and depends on external variables (e.g., an Expression like "h1 = g1^w", where w is a {@link de.upb.crypto.craco.protocols.arguments.sigma.schnorr.variables.SchnorrVariable})</li>
