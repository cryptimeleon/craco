...
public class PS18SignatureSchemePrec implements StandardMultiMessageSignatureScheme {
    ...
    public PS18SignatureSchemePrec(PSPublicParameters pp) {
        this.pp = pp;
    }

    public PS18SignatureSchemePrec(Representation repr) {
